...
namespace Microsoft.Psi.Interop.Transport
{
    ...
    public class TcpSimpleSource<T> : ISourceComponent, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TcpSimpleSource{T}"/> class.
        /// </summary>
        ...
        public TcpSimpleSource(
            string address,
            int port,
            IFormatDeserializer deserializer,
            Action<T> deallocator = null,
            string name = nameof(TcpSimpleSource<T>))
        {
        ...
        /// <summary>
        /// Definition of delegate forhandling incoming message..
        /// </summary>
        /// <param name="message">The incoming message.</param>
        /// <param name="dateTime">The timestamp of the message.</param>
        public delegate void OnMessageRecievedDelegate(T message, DateTime dateTime);

        /// <summary>
        /// Gets or sets an event on mesaage recieved.
        /// </summary>
        ...
        /// <summary>
        /// Element that define the excpected last timestamp recieved.
        /// </summary>
        /// <param name="time">EnTime that will be set.</param>
        ...
        private (dynamic, DateTime) ReadNextFrame(BinaryReader binaryReader)
        {
            ...
            return this.deserializer.DeserializeMessage(this.frameBuffer, 0, frameLength);
        }
        ...
        private void ReadFrames()
        {
            ...
            try
            {
                ...
                {
                    this.OnMessageRecieved(message, timestamp);
