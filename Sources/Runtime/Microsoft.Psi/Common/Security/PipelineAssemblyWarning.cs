...
namespace Microsoft.Psi.Common
{
    ...
    /// </summary>
    public static class PipelineAssemblyWarning
    {
        /// <summary>
        /// The warning title.
        /// </summary>
        public const string Title = "Third-Party Pipeline Assembly Security Warning";

        /// <summary>
        /// The first line of the warning message, above the list of assemblies.
        /// </summary>
        public const string Line1 = "You have chosen to add the following third-party assembly to {0}. These components and their dependencies will be able to execute their own code on your machine in the context of the {0} user.";
        ...
        /// </summary>
        public const string Question = "Are you sure you wish to run this pipeline to {0}?";
    }
}
